            ...
            <div className="relative hidden h-full flex-col bg-gradient-to-br from-green-800 to-green-900 p-10 text-white lg:flex dark:border-r">
                ...
                <div className="relative z-20 mt-auto">
                    <blockquote className="space-y-2">
                        <p className="text-lg">
                            &quot;Where young champions are born and dreams take flight. Join our elite football academy.&quot;
                        </p>
                        <footer className="text-sm">Academy Director - OSAAK FC</footer>
                    </blockquote>
                </div>
            </div>
                    ...
                    <Card className="border-0 shadow-none">
                        <CardHeader className="space-y-1">
                            ...
                            <CardDescription className="text-center">
                                Sign in to your OSAAK FC account to continue your journey
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <LoginForm />
